...
namespace DVLD.MainForms.MainRelatedForms.Application
{
    public partial class ManageLocalLicenseApplications : Form
    {
        ...
        private void IssueDrivingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            IssueDriverLicenseFirstTimeForm issueDriverLicenseFirst
                = new IssueDriverLicenseFirstTimeForm(_user);
            issueDriverLicenseFirst.Load_Info(LDLApplicationID);
            issueDriverLicenseFirst.StartPosition = FormStartPosition.CenterScreen;
            issueDriverLicenseFirst.ShowDialog();
            ...
            if (clsLicensesBusinessLayer.IsLicenseExist(app.ApplicationID))
            {
        ...
        private void showLicenseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            DriverLicenseInfoForm licenseInfoForm =
                new DriverLicenseInfoForm();
            licenseInfoForm.LoadInfo(LDLApplicationID);
        ...
        private void showPersonLicenseHistoryToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string nno =
             Convert.ToString(dgvManageLicenseApplications.SelectedRows[0].
             Cells["NationalNo"].Value);

            

            DriverLicensesHistoryForm driverLicensesHistory = new DriverLicensesHistoryForm();
            driverLicensesHistory.LoadInfo(nno);
            driverLicensesHistory.StartPosition = FormStartPosition.CenterScreen;
